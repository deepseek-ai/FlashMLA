...
//         TORCH_CHECK(attn_sink.value().dtype() == torch::kFloat32);
//         CHECK_SHAPE(attn_sink.value(), h_q);
...
//         TORCH_CHECK(topk_length.value().is_contiguous());
//     }
...
//         have_attn_sink ? (float*)attn_sink->data_ptr() : nullptr,
//         have_topk_length ? (int*)topk_length->data_ptr() : nullptr,
